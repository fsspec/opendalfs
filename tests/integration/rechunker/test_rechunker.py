...
def test_rechunk_between_opendalfs_mappers(opendal_fs, opendal_root):
    ...
    fixtures.
    """
    source_store = opendal_fs.get_mapper(f"{opendal_root}/rechunker/source.zarr")
    target_store = opendal_fs.get_mapper(f"{opendal_root}/rechunker/target.zarr")
    temp_store = opendal_fs.get_mapper(f"{opendal_root}/rechunker/temp.zarr")
